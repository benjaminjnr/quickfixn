...
public class SecurityDefinitionUpdateReport : Message
{
    ...
    public void Set(SecurityReportID val) { SecurityReportID = val; }
    public SecurityReportID Get(SecurityReportID val) { GetField(val); return val; }
    public bool IsSet(SecurityReportID val) { return IsSetSecurityReportID(); }
    ...
    public void Set(SecurityUpdateAction val) { SecurityUpdateAction = val; }
    public SecurityUpdateAction Get(SecurityUpdateAction val) { GetField(val); return val; }
    public bool IsSet(SecurityUpdateAction val) { return IsSetSecurityUpdateAction(); }
