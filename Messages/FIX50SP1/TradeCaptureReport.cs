...
public class TradeCaptureReport : Message
{
    ...
    public class NoSidesGroup : Group
    {
        ...
        public void Set(SideQty val) { SideQty = val; }
        public SideQty Get(SideQty val) { GetField(val); return val; }
        public bool IsSet(SideQty val) { return IsSetSideQty(); }
