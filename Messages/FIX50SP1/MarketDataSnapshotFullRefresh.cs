...
public class MarketDataSnapshotFullRefresh : Message
{
    ...
    public void Set(MDReportID val) { MDReportID = val; }
    public MDReportID Get(MDReportID val) { GetField(val); return val; }
    public bool IsSet(MDReportID val) { return IsSetMDReportID(); }
    public bool IsSetMDReportID() { return IsSetField(Tags.MDReportID); }
    ...
    public void Set(RefreshIndicator val) { RefreshIndicator = val; }
    public RefreshIndicator Get(RefreshIndicator val) { GetField(val); return val; }
    public bool IsSet(RefreshIndicator val) { return IsSetRefreshIndicator(); }
    public bool IsSetRefreshIndicator() { return IsSetField(Tags.RefreshIndicator); }
