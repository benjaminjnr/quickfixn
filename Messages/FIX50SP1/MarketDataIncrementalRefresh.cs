...
public class MarketDataIncrementalRefresh : Message
{
    ...
    public class NoMDEntriesGroup : Group
    {
        ...
        public void Set(MDOriginType val) { MDOriginType = val; }
        public MDOriginType Get(MDOriginType val) { GetField(val); return val; }
        public bool IsSet(MDOriginType val) { return IsSetMDOriginType(); }
        public bool IsSetMDOriginType() { return IsSetField(Tags.MDOriginType); }
        ...
        public void Set(TradeVolume val) { TradeVolume = val; }
        public TradeVolume Get(TradeVolume val) { GetField(val); return val; }
        public bool IsSet(TradeVolume val) { return IsSetTradeVolume(); }
        public bool IsSetTradeVolume() { return IsSetField(Tags.TradeVolume); }
        ...
        public void Set(MDQuoteType val) { MDQuoteType = val; }
        public MDQuoteType Get(MDQuoteType val) { GetField(val); return val; }
        public bool IsSet(MDQuoteType val) { return IsSetMDQuoteType(); }
        public bool IsSetMDQuoteType() { return IsSetField(Tags.MDQuoteType); }
        ...
        public void Set(DealingCapacity val) { DealingCapacity = val; }
        public DealingCapacity Get(DealingCapacity val) { GetField(val); return val; }
        public bool IsSet(DealingCapacity val) { return IsSetDealingCapacity(); }
        public bool IsSetDealingCapacity() { return IsSetField(Tags.DealingCapacity); }

        public MDEntrySpotRate MDEntrySpotRate
        {
            get
            {
                MDEntrySpotRate val = new();
                GetField(val);
                return val;
            }
            set  => SetField(value);
        ...
        public void Set(MDEntrySpotRate val) { MDEntrySpotRate = val; }
        public MDEntrySpotRate Get(MDEntrySpotRate val) { GetField(val); return val; }
        public bool IsSet(MDEntrySpotRate val) { return IsSetMDEntrySpotRate(); }
        public bool IsSetMDEntrySpotRate() { return IsSetField(Tags.MDEntrySpotRate); }

        public MDEntryForwardPoints MDEntryForwardPoints
        {
            get
            {
                MDEntryForwardPoints val = new();
                GetField(val);
                return val;
            }
            set  => SetField(value);
        ...
        public void Set(MDEntryForwardPoints val) { MDEntryForwardPoints = val; }
        public MDEntryForwardPoints Get(MDEntryForwardPoints val) { GetField(val); return val; }
        public bool IsSet(MDEntryForwardPoints val) { return IsSetMDEntryForwardPoints(); }
        public bool IsSetMDEntryForwardPoints() { return IsSetField(Tags.MDEntryForwardPoints); }

        public MDPriceLevel MDPriceLevel
        {
            get
            {
                MDPriceLevel val = new();
                GetField(val);
                return val;
            }
            set  => SetField(value);
        ...
        public void Set(MDPriceLevel val) { MDPriceLevel = val; }
        public MDPriceLevel Get(MDPriceLevel val) { GetField(val); return val; }
        public bool IsSet(MDPriceLevel val) { return IsSetMDPriceLevel(); }
        public bool IsSetMDPriceLevel() { return IsSetField(Tags.MDPriceLevel); }
        ...
        public void Set(MDSubBookType val) { MDSubBookType = val; }
        public MDSubBookType Get(MDSubBookType val) { GetField(val); return val; }
        public bool IsSet(MDSubBookType val) { return IsSetMDSubBookType(); }
        public bool IsSetMDSubBookType() { return IsSetField(Tags.MDSubBookType); }
        ...
        public NoOfSecSizes NoOfSecSizes
        {
            get
            {
                NoOfSecSizes val = new();
                GetField(val);
                return val;
            }
            set  => SetField(value);
        ...
        public void Set(NoOfSecSizes val) { NoOfSecSizes = val; }
        public NoOfSecSizes Get(NoOfSecSizes val) { GetField(val); return val; }
        public bool IsSet(NoOfSecSizes val) { return IsSetNoOfSecSizes(); }
        public bool IsSetNoOfSecSizes() { return IsSetField(Tags.NoOfSecSizes); }
        ...
        public HaltReasonChar HaltReasonChar
        {
            get
            {
                HaltReasonChar val = new();
                GetField(val);
                return val;
            }
            set  => SetField(value);
        ...
        public void Set(HaltReasonChar val) { HaltReasonChar = val; }
        ...
        public NoStatsIndicators NoStatsIndicators
        {
            get
            {
                NoStatsIndicators val = new();
                GetField(val);
                return val;
            }
            set  => SetField(value);
        ...
        public void Set(NoStatsIndicators val) { NoStatsIndicators = val; }
        public NoStatsIndicators Get(NoStatsIndicators val) { GetField(val); return val; }
        public bool IsSet(NoStatsIndicators val) { return IsSetNoStatsIndicators(); }
        public bool IsSetNoStatsIndicators() { return IsSetField(Tags.NoStatsIndicators); }
        ...
        {
            public static int[] DefaultFieldOrder = [Tags.MDSecSizeType, Tags.MDSecSize, 0];

            [Obsolete("Use DefaultFieldOrder instead.  This will be removed in a future release.")]
            public static int[] fieldOrder = {Tags.MDSecSizeType, Tags.MDSecSize, 0};

            public NoOfSecSizesGroup()
              : base(Tags.NoOfSecSizes, Tags.MDSecSizeType, DefaultFieldOrder)
            {
            }
            ...
            public void Set(MDSecSizeType val) { MDSecSizeType = val; }
            public MDSecSizeType Get(MDSecSizeType val) { GetField(val); return val; }
            public bool IsSet(MDSecSizeType val) { return IsSetMDSecSizeType(); }
            public bool IsSetMDSecSizeType() { return IsSetField(Tags.MDSecSizeType); }
            ...
            public void Set(MDSecSize val) { MDSecSize = val; }
            public MDSecSize Get(MDSecSize val) { GetField(val); return val; }
            public bool IsSet(MDSecSize val) { return IsSetMDSecSize(); }
            public bool IsSetMDSecSize() { return IsSetField(Tags.MDSecSize); }
        }

        public class NoStatsIndicatorsGroup : Group
        {
            public static int[] DefaultFieldOrder = [Tags.StatsType, 0];

            [Obsolete("Use DefaultFieldOrder instead.  This will be removed in a future release.")]
            public static int[] fieldOrder = {Tags.StatsType, 0};

            public NoStatsIndicatorsGroup()
              : base(Tags.NoStatsIndicators, Tags.StatsType, DefaultFieldOrder)
            {
            }
            ...
            public void Set(StatsType val) { StatsType = val; }
            public StatsType Get(StatsType val) { GetField(val); return val; }
            public bool IsSet(StatsType val) { return IsSetStatsType(); }
            public bool IsSetStatsType() { return IsSetField(Tags.StatsType); }
        }
    }
